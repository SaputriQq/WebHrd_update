...
<head>
    ...
    <title>PENCARIAN SHIFT KARYAWAN</title>
...
<div class="container">
    ...
    <div class="row mt-3">
        <div class="col-lg col-md">
            <div class="form-floating mt-3 mb-2">
                ...
                <div class="mb-3 row justify-content-md-center">
                    <label for="bulana" class="col-sm-2 col-form-label">Tgl.Sampai</label>
                    <div class="col-sm-10">
    ...
    <button class="btn btn-success" type="button" onclick="window.location.href=`carishift.asp`"><i class="fa fa-coffee"></i>Refresh</button>
    <div class="row mt-3">
        <div class="col-lg">
            <table class="table table-striped table-hover table-daftardivisi">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Aktif</td>
                        <td>
                            <a href="detailshift.asp?id=<%= rs("Div_Code") %>&bulana=<%= bulana%>&bulane=<%= bulane%>&cabang=<%= cabang%>" class="badge bg-info text-light">Detail</a>
                        </td>
                    </tr>
                    <% 
                ...
                <ul class="pagination">
                    <li class="page-item">
                        <% if requestrecords <> 0 then %>
                            <a class="page-link prev" href="carishift.asp?offset=<%= requestrecords - recordsonpage%>&page=<%=pagelistcounter%>&bulana=<%= bulana %>&bulane=<%= bulane %>">&#x25C4; Prev </a>
                        <% else %>
                    ...
                    <li class="page-item d-flex" style="overflow-y:auto;">	
                        ...
                        %>
                            <a class="page-link hal" href="carishift.asp?offset=<% = pagelist %>&page=<%=pagelistcounter%>&bulana=<%= bulana %>&bulane=<%= bulane %>"><%= pagelistcounter %></a> 
                        <%
                    ...
                    <li class="page-item">
                            ...
                            <a class="page-link next" href="carishift.asp?offset=<%= requestrecords + recordsonpage %>&page=<%=pagelistcounter%>&bulana=<%= bulana %>&bulane=<%= bulane %>">Next &#x25BA;</a>
                            <% else %>
